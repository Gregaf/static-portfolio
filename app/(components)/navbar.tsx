  ...
  return (
    <nav className="px-4 py-4 flex items-center justify-between bg-slate-700 p-6">
      ...
      <div className="relative flex items-center">
        ...
        <div className="flex items-center border-l border-white ml-6 pl-6">
          <a href="https://github.com/gregaf">
            <FaGithub
              className="transition duration-250 mr-3 opacity-70 hover:opacity-100"
              size={24}
            />
          </a>
          <a href="https://www.linkedin.com/in/gregory-freitas-b7068011b">
            <FaLinkedin
              className="transition duration-250 mr-3 opacity-70 hover:opacity-100"
              size={24}
            />
